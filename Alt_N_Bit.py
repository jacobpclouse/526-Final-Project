"""
  ...
  ____  _     ______    ___  ____   ____    ____  ______  ____  __ __    ___      ____          ____   ____  ______ 
 /    || |   |      |  /  _]|    \ |    \  /    ||      ||    ||  |  |  /  _]    |    \        |    \ |    ||      |
|  o  || |   |      | /  [_ |  D  )|  _  ||  o  ||      | |  | |  |  | /  [_     |  _  | _____ |  o  ) |  | |      |
|     || |___|_|  |_||    _]|    / |  |  ||     ||_|  |_| |  | |  |  ||    _]    |  |  ||     ||     | |  | |_|  |_|
|  _  ||     | |  |  |   [_ |    \ |  |  ||  _  |  |  |   |  | |  :  ||   [_     |  |  ||_____||  O  | |  |   |  |  
|  |  ||     | |  |  |     ||  .  \|  |  ||  |  |  |  |   |  |  \   / |     |    |  |  |       |     | |  |   |  |  
|__|__||_____| |__|  |_____||__|\_||__|__||__|__|  |__|  |____|  \_/  |_____|    |__|__|       |_____||____|  |__|  
